                ...
                <div className="space-y-8">
                    ...
                    <section className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                        <div>
                            ...
                            <div className="mt-6">
                                <Link href="/contact"><BlueButton label="Contact our team" width="w-auto" /></Link>
                            </div>
                        </div>
                    ...
                    <footer className="text-center py-6">
                        ...
                        <div className="flex items-center justify-center gap-4">
                            <Link href="/auth/register"><BlueButton label="Get Started" width="" /></Link>
                            <Link href="/contact" className="text-sm text-lightBlue underline">Contact Sales</Link>
                        </div>
                    </footer>
                </div>
            </div>
